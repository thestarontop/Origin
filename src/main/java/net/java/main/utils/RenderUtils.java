...
public class RenderUtils extends MinecraftInstance{
    ...
    public static void drawRoundedRect(Matrix4f p_93106_, float x, float y, float xEnd, float yEnd, float radius, int color) {
        float $$8 = (float)(color >> 24 & 255) / 255.0F;
        float $$9 = (float)(color >> 16 & 255) / 255.0F;
        float $$10 = (float)(color >> 8 & 255) / 255.0F;
        float $$11 = (float)(color & 255) / 255.0F;
        float z = 0;
        if (x > xEnd) {
            z = x;
            x = xEnd;
        ...
        double x1 = x + radius;
        double y1 = y + radius;
        double x2 = xEnd - radius;
        double y2 = yEnd - radius;
        ...
        for (double i = 0; i <= 90; i += 1)
            $$12.vertex(p_93106_, (float) (x2 + Math.sin(i * degree) * radius), (float) (y2 + Math.cos(i * degree) * radius),0f).color($$9, $$10, $$11, $$8).endVertex();
        for (double i = 90; i <= 180; i += 1)
            $$12.vertex(p_93106_, (float) (x2 + Math.sin(i * degree) * radius), (float) (y1 + Math.cos(i * degree) * radius),0f).color($$9, $$10, $$11, $$8).endVertex();
        for (double i = 180; i <= 270; i += 1)
            $$12.vertex(p_93106_, (float) (x1 + Math.sin(i * degree) * radius), (float) (y1 + Math.cos(i * degree) * radius),0f).color($$9, $$10, $$11, $$8).endVertex();
        for (double i = 270; i <= 360; i += 1)
            $$12.vertex(p_93106_, (float) (x1 + Math.sin(i * degree) * radius), (float) (y2 + Math.cos(i * degree) * radius),0f).color($$9, $$10, $$11, $$8).endVertex();

        $$12.end();
        BufferUploader.end($$12);
        RenderSystem.enableTexture();
        RenderSystem.disableBlend();
    }
    public static void drawRect(PoseStack matrixStack, float x, float y, float x2, float y2, int color) {
        Screen.fill(matrixStack, (int) x, (int) y, (int) x2, (int) y2,color);
    }
