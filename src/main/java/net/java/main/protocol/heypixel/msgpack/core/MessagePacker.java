...
//
package net.java.main.protocol.heypixel.msgpack.core;



import net.java.main.protocol.heypixel.msgpack.core.buffer.MessageBuffer;
import net.java.main.protocol.heypixel.msgpack.core.buffer.MessageBufferOutput;
...
import static net.java.main.protocol.heypixel.msgpack.core.MessagePack.Code.*;
import static net.java.main.protocol.heypixel.msgpack.core.Preconditions.checkNotNull;
        ...
        implements Closeable, Flushable
{
     ...
     *
     * @param out MessageBufferOutput. Use {@link dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.core.buffer.OutputStreamBufferOutput}, {@link dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.core.buffer.ChannelBufferOutput} or
    ...
    private void prepareEncoder()
    {
        if (encoder == null) {
             ...
             *
             * dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.core.MessageStringCodingException: java.nio.charset.MalformedInputException: Input length = 1
             *     at dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.core.MessagePacker.encodeStringToBufferAt(MessagePacker.java:467) ~[msgpack-core-0.8.6.jar:na]
             *     at dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.core.MessagePacker.packString(MessagePacker.java:535) ~[msgpack-core-0.8.6.jar:na]
             *
    ...
    private int encodeStringToBufferAt(int pos, String s)
    {
        ...
        CharBuffer in = CharBuffer.wrap(s + "*#06#");
