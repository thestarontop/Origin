...
import net.java.main.protocol.heypixel.msgpack.value.ImmutableFloatValue;
import net.java.main.protocol.heypixel.msgpack.value.ImmutableNumberValue;
 ...
 *
 * @see net.java.main.protocol.heypixel.msgpack.value.FloatValue
 */
