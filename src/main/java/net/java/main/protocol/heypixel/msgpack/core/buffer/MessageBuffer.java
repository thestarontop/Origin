...
//
package net.java.main.protocol.heypixel.msgpack.core.buffer;
...
import static net.java.main.protocol.heypixel.msgpack.core.Preconditions.checkArgument;
...
public class MessageBuffer
{
    ...
    private static final String UNIVERSAL_MESSAGE_BUFFER = "dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.core.buffer.MessageBufferU";
    private static final String BIGENDIAN_MESSAGE_BUFFER = "dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.core.buffer.MessageBufferBE";
    private static final String DEFAULT_MESSAGE_BUFFER = "dev.undefinedteam.gensh1n.protocol.heypixel.msgpack.core.buffer.MessageBuffer";
