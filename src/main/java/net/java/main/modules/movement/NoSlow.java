...
public class NoSlow extends Module {
    ...
    public static ListValue mode = new ListValue("type", new String[]{"Grim", "Hypixel", "Vanilla"},"Grim");
    ...
    public void onUpdate(UpdateEvent event){
        if (Objects.equals(mode.getValue(), "Grim")){
            if (mc.player != null && mc.player.isUsingItem() && shouldstartsprint != mc.player.isSprinting()) {
